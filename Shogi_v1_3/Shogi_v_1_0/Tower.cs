...
namespace Shogi_v_1_0
{
    ...
    class Tower : Piece
    {
        ...
        public Tower(int row, int column, int color) : base(row, column, color)
        {
            ...
            if (GetIsPromoted()) imageWhite.UriSource = new Uri(@"..\..\Properties\TowerPromotedWhite.bmp", UriKind.RelativeOrAbsolute);
            if (!GetIsPromoted()) imageWhite.UriSource = new Uri(@"..\..\Properties\TowerWhite.bmp", UriKind.RelativeOrAbsolute);
            imageWhite.EndInit();
            ...
            if (GetIsPromoted()) imageBlack.UriSource = new Uri(@"..\..\Properties\TowerPromotedBlack.bmp", UriKind.RelativeOrAbsolute);
            if (!GetIsPromoted()) imageBlack.UriSource = new Uri(@"..\..\Properties\TowerBlack.bmp", UriKind.RelativeOrAbsolute);
            imageBlack.EndInit();
