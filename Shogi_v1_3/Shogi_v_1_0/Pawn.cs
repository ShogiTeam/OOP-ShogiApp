...
namespace Shogi_v_1_0
{
    ...
    class Pawn : Piece
    {
        ...
        public Pawn(int row, int column, int color) : base(row, column, color)
        {
            ...
            if (GetIsPromoted()) imageWhite.UriSource = new Uri(@"..\..\Properties\PawnPromotedWhite.bmp", UriKind.RelativeOrAbsolute);
            if (!GetIsPromoted()) imageWhite.UriSource = new Uri(@"..\..\Properties\PawnWhite.bmp", UriKind.RelativeOrAbsolute);
            imageWhite.EndInit();
            ...
            if (!GetIsPromoted()) imageBlack.UriSource = new Uri(@"..\..\Properties\PawnBlack.bmp", UriKind.RelativeOrAbsolute);
            imageBlack.EndInit();
