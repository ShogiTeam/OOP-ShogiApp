...
namespace Shogi_v_1_0
{
    ...
    class SilverGeneral : Piece
    {
        ...
        public SilverGeneral(int row, int column, int color) : base(row, column, color)
        {
            ...
            if (GetIsPromoted()) imageWhite.UriSource = new Uri(@"Shogi_v_1_0\Properties\SilverGeneralPromotedWhite.bmp", UriKind.RelativeOrAbsolute);
            if (!GetIsPromoted()) imageWhite.UriSource = new Uri(@"Shogi_v_1_0\Properties\SilverGeneralWhite.bmp", UriKind.RelativeOrAbsolute);
            imageWhite.EndInit();
            ...
            if (GetIsPromoted()) imageBlack.UriSource = new Uri(@"Shogi_v_1_0\Properties\SilverGeneralPromotedBlack.bmp", UriKind.RelativeOrAbsolute);
            if (!GetIsPromoted()) imageBlack.UriSource = new Uri(@"Shogi_v_1_0\Properties\SilverGeneralBlack.bmp", UriKind.RelativeOrAbsolute);
            imageBlack.EndInit();
